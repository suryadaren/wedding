...
<head>
  ...
  <title>{{config('app.name')}} | Customer Pages</title>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{{Storage::url(auth()->guard('customer')->user()->customer->first()->foto_profil)}}" class="img-circle elevation-2" alt="img">
        </div>
        <div class="info">
          <a href="#" class="d-block">{{auth()->guard('customer')->user()->username}}</a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            <a href="/customer/pemesanan" class="nav-link {{ (request()->is('customer/pemesanan*')) ? 'active' : '' }}">
