                ...
                <tr>
                    <td class="content-cell" style="font-family: Arial, Helvetica, sans-serif; box-sizing: border-box; padding: 35px">
                        <p style="font-family: Arial, Helvetica, sans-serif; box-sizing: border-box; color: #242729; font-size: 14px; line-height: 1.5em; margin-top: 0; text-align: left;">
                            ...
                            Pemesanan dengan data yang tertera dibawah ini telah selesai. silahkan lakukan pencairan dana ke :  
                            <br /><br />
                            <table>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        {{$pemesanan->wedding_organizer->nama_bank}}
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        {{$pemesanan->wedding_organizer->nomor_rekening}}
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        {{$pemesanan->wedding_organizer->nama_pemilik}}
                                    </td>
                                </tr>
                                <tr>
                                    <td>
