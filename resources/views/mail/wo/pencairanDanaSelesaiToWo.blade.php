                ...
                <tr>
                    <td class="content-cell" style="font-family: Arial, Helvetica, sans-serif; box-sizing: border-box; padding: 35px">
                        <p style="font-family: Arial, Helvetica, sans-serif; box-sizing: border-box; color: #242729; font-size: 14px; line-height: 1.5em; margin-top: 0; text-align: left;">
                            Hi, {{$pencairan_dana->pemesanan->wedding_organizer->nama_perusahaan}}.<br /><br />
                            Admin Wedding.co telah melakukan pencairan dana untuk pemesanan anda dibawah ini. 
                            <br /><br />
                            <table>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                         : {{$pencairan_dana->pemesanan->paket->nama_paket}}
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                         : {{$pencairan_dana->pemesanan->tanggal}}
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                         : {{$pencairan_dana->pemesanan->alamat}}
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                         : {{$pencairan_dana->pemesanan->nama_pengantin_pria}}
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                         : {{$pencairan_dana->pemesanan->nama_pengantin_wanita}}
                                    </td>
                                </tr>
                                <tr>
                                    <td>
