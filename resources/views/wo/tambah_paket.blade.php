          ...
          <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                  <h5 class="title">Masukan Data Paket</h5>
                </div>
              <div class="card-body">
                <div class="tab-content">
                  <div id="settings">
                    <form class="form-horizontal" action="/wo/simpan_paket" enctype="multipart/form-data" method="post"> {{csrf_field()}}
                      <div class="form-group row">
                        <label for="inputName" class="col-sm-2 col-form-label">Nama Paket</label>
                        <div class="col-sm-10">
                          <input type="text" name="nama_paket" value="{{old('nama_paket')}}" class="form-control" id="inputName">
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="file" name="foto" value="{{old('foto')}}" class="form-control" id="inputName">
                        </div>
                      </div>
                      @if($errors->has('foto'))
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <textarea class="form-control" name="deskripsi" style="width: 100%">{{old('deskripsi')}}</textarea>
                        </div>
                      </div>
